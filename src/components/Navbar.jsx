        ...
        className='container mx-auto flex justify-between
         items-centerpy-4 px-6 md:px-20 lg:px32 bg-transparent'>
            ...
            <ul className='hidden md:flex gap-7'>
                <a href="#Header"
                className='cursor-pointer text-white hover:text-gray-400'>Home
                </a>
                <a href="#About"
                className='cursor-pointer text-white hover:text-gray-400'>About
                </a>
                <a href="#Projects"
                className='cursor-pointer text-white hover:text-gray-400'>Projects
                </a>
                <a href="#Testimonials"
                className='cursor-pointer text-white hover:text-gray-400 '>Testimonials
                </a>
            </ul>
